# Soham Padia — Research

## Focus Areas
- Natural Language Processing (NLP)
- Reinforcement Learning (RL/DRL/MARL)
- Multimodal AI (speech + vision + text)
- AI systems for robustness and real-world deployment
...
- **Venue:** Springer
- **Year:** 2025
- **Link:** [https://doi.org/10.1007/978-981-97-9855-1_10](https://doi.org/10.1007/978-981-97-9855-1_10)
- **Summary:** Proposed an NLP pipeline to interpret natural-language statistical prompts and solve chi-square goodness-of-fit and independence test tasks.
- **Keywords:** NLP, Statistics, Feature Selection
